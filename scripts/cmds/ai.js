  ...
  onStart: async function({ api, event, args }) {
    ...
    try {
      ...
      if (!np) {
        ...
        return api.sendMessage('💬 La 𝗠𝗜 à votre service. Posez vos questions 🍧', event.threadID, event.messageID);
      ...
      const cliff = await new Promise(resolve => {
        ...
        api.sendMessage('[♻️] Patientez svp....', event.threadID, (err, info1) => {
      ...
      gpt({
        ...
        messages: [
...

          {
            ...
            content: `💬 𝘚𝘢𝘭𝘶𝘵 ! 𝘑𝘦 𝘴𝘶𝘪𝘴 𝘶𝘯𝘦 𝘪𝘯𝘵𝘦𝘭𝘭𝘪𝘨𝘦𝘯𝘤𝘦 𝘢𝘳𝘵𝘪𝘧𝘪𝘤𝘪𝘦𝘭𝘭𝘦 𝘥𝘦́𝘷𝘦𝘭𝘰𝘱𝘱𝘦́𝘦 𝘢𝘶 𝘴𝘦𝘳𝘷𝘪𝘤𝘦 𝘥𝘦 𝘭𝘢 𝗠𝗜 😇. 𝖰𝗎𝖾 𝗉𝗎𝗂𝗌-𝗃𝖾 𝖿𝖺𝗂𝗋𝖾 𝗉𝗈𝗎𝗋 𝗍𝗈𝗂 ?`
