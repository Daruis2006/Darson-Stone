...
module.exports = {
    ...
    const name = data.name;
	  const xyrene = {
	    body: `𝗠𝗔𝗜𝗧𝗥𝗘:${name}` + getLang("myPrefix", global.GoatBot.config.prefix, utils.getPrefix(event.threadID)),
	    attachment: await global.utils.getStreamFromURL("https://i.ibb.co/qNMxM1K/image.jpg")
				};
